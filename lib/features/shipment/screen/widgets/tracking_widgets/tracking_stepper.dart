...
class TrackingStepper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, String>> steps = [
      ...
      {'title': 'تم قبول الشحنة', 'subtitle': deliveryInfo['name'] ?? ''},
      {'title': 'في الطريق إليك'},
      {'title': 'المندوب بالقرب منك'},
      {'title': 'تم تسليم الشحنة للمندوب'},
      {'title': 'في الطريق للزبون', 'subtitle': recipientInfo['name'] ?? ''},
      {'title': 'المندوب بالقرب من الزبون'},
      {'title': 'تم التسليم للزبون', 'subtitle': shipmentInfo['name'] ?? ''},
    ];
                    ...
                    return Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              if (steps[index]['subtitle'] != null && steps[index]['subtitle']!.isNotEmpty)
                                Text(
                        ...
                        if (steps[index]['title'] == 'تم قبول الشحنة' ||
                            ...
                            steps[index]['title'] == 'بانتظار القبول')
                          Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                if (steps[index]['title'] == 'بانتظار القبول')
                                  IconButton(
                                    color: status == 0
                                        ? TColors.primary
                                        : TColors.buttonDisabled,
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text(
            'هل أنت متأكد من أنك تريد إلغاء الشحنة؟',
            style: TextStyle(
              fontFamily: 'Cairo',
              fontSize: 12.sp,
            ),
