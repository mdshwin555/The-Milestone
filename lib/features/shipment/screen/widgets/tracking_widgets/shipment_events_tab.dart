  ...
  return Padding(
    ...
    child: Align(
      ...
      child: controller.shipmentInfo.value['shipment_status'] == 10
        ...
        recipientInfo: Map<String, dynamic>.from(recipientInfo),
        deliveryInfo: Map<String, dynamic>.from(deliveryInfo),
        shipmentInfo: Map<String, dynamic>.from(shipmentInfo),
        shipmentNumber: shipmentInfo['shipment_number'], // تأكد من تمرير shipmentNumber
