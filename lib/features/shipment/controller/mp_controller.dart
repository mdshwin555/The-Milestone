...
class MpController extends GetxController with WidgetsBindingObserver {
  var recipientLat = 31.9539.obs; // Coordinates of Amman
  var recipientLong = 35.9106.obs; // Coordinates of Amman
  late LatLng initialPosition = LatLng(31.9539, 35.9106); // Coordinates of Amman
  ...
  void onTap(LatLng location) {
    if (isPointInPolygon(location, jordanPolygonCoords)) {
