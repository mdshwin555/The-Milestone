...
class AddShipmentController extends GetxController {
  ...
  void fetchShippingTypes() async {
    var response = await crud.getData(
      'https://api.wasenahon.com/milestone/admin/shipping_types/get_shipping_types.php',
      {},
    );
  ...
  Future<void> calculateShippingFee() async {
   ...
   // shipmentDistance.value=distance;
    final request = http.MultipartRequest(
        'POST',
        Uri.parse(
            'https://api.wasenahon.com/milestone/merchant/shipments/calculateShippingFee.php'));
